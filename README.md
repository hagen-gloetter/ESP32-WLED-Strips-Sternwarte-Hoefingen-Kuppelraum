...
Da Technik und Lichtqualität über die Jahre nachgelassen haben, wurde die Beleuchtung auf
ein modernes, wartbares LED-System umgestellt. Als Basis dient WLED als etabliertes Open-Source-
Projekt, erweitert um eine auf den Beobachtungsbetrieb abgestimmte Preset- und Button-Logik.
So bleibt das Rotlicht astronomietauglich für lichtschwache Objekte wie Galaxien, während
Mitarbeitende und Besuchende gleichzeitig ausreichend Orientierung im Kuppelraum erhalten.
...
|--------|-------------|-----------|--------------|
| **Rot** 🔴 | Rot 50 % (Preset 20) | Jede zehnte rot (Preset 22) | Rot 100 % (Preset 21) |
| **Weiß** ⚪ | Weiß 50 % (Preset 23) | Weiß 10 % (Preset 25) | Weiß 100 % (Preset 24) |
| **Aus** ⚫ | Alle aus (Preset 26) | Jede zehnte (Preset 28) | Jeder zweite (Preset 27) |
| **Fun** 🎨 | Rainbow (Preset 29) | Theater Chase (Preset 31) | Knight Rider (Preset 30) |
